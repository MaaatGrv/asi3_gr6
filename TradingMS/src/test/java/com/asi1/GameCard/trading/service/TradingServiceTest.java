...
public class TradingServiceTest {
        ...
        public void testSellCard() {
                ...
                doNothing().when(restTemplate).put(eq("http://gateway/user/" + userDto.getId()), eq(userDto),
                                eq(UserDto.class));

                // Mock restTemplate.put() for cardDto
                doNothing().when(restTemplate).put(eq("http://gateway/card/" + cardDto.getId()), eq(cardDto),
                                eq(CardDto.class));
