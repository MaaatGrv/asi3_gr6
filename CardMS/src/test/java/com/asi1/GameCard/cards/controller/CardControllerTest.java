...
public class CardControllerTest {
    ...
    public void testUpdateCard() throws Exception {
        Card updatedCard = new Card("UpdatedCard", "An updated card", "TestFamily", "TestAffinity",
                "TestImgUrl", "TestSmallImgUrl", 10, 100, 50, 50, 100, 1L);
        updatedCard.setId(1L);

        when(cardService.updateCard(anyLong(), any(Card.class))).thenReturn(updatedCard);
